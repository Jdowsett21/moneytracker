...
export const timeFilterArray = [
  // static solution
  {
    range1: moment('2020-10-31')
      .subtract(7, 'days')
      .startOf('day')
      .toISOString(),
    range2: moment('2020-10-31').endOf('day').toISOString(),
    length: 7,
    unit: 'days',
    format: 'MMM-DD-YYYY',
    label: 'Last 7 days',
  ...
  {
    range1: moment('2020-10-31').date(1).startOf('day').toISOString(),
    range2: moment('2020-10-31').endOf('day').toISOString(),
  ...
  {
    range1: moment('2020-10-31').month(0).date(1).startOf('day').toISOString(),
    range2: moment('2020-10-31').endOf('day').toISOString(),
  ...
  },
  {
    range1: moment('2020-10-31')
      ...
      .startOf('day')
      .toISOString(),
    range2: moment('2020-10-31').startOf('day').toISOString(),
    // length:
    unit: 'months',
    format: 'MMM-YYYY',
