...
export const timeFilterArray = [
  ...
  {
    range1: moment().date(1).subtract(3, 'months').toISOString(),
    range2: today,
    length: 3,
    unit: 'months',
    format: 'MMM',
  ...
  {
    range1: moment().date(1).subtract(6, 'months').toISOString(),
    range2: today,
    length: 6,
    unit: 'months',
    format: 'MMM',
  ...
  {
    range1: moment().date(1).subtract(12, 'months').toISOString(),
    range2: today,
    length: 12,
    unit: 'months',
    format: 'MMM',
